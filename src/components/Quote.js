...
var random = Math.floor(Math.random() * months.length);
    ...
    let QuoteSource = "https://youtube.com/";

    if (RandomQuote === "Over 2 billion people’s livelihoods depend on forests.") {
let QuoteSource = "https://www.ecomatcher.com/tree-resources/";
}
...
let QuoteSource = "https://www.precisiontreemn.com/tips/14-fun-facts-about-trees.html";
}
